...
const SalesTargetReport = () => {
  ...
  /* ================= FILTER ================= */
    ...
    useEffect(() => {
      setCurrentPage(1);
    }, [selectedUser, searchText, statusFilter, selectedYear, selectedMonth]);
  ...
  return (
    <div className="p-4 mx-auto font-[system-ui] bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center mb-6">
        <button onClick={() => navigate("/reportpage")} className="text-gray-600 hover:text-gray-900 mr-4 text-2xl p-2 rounded-full hover:bg-gray-200 transition" >
          <FaArrowLeft />
        </button>
        <h1 className="text-2xl font-bold text-gray-900"> Sales Target vs Achievement </h1>
      </div>
  ...
  {selectedYear && (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl shadow-md p-4 h-[280px] flex flex-col">
        <h3 className="text-sm font-semibold text-blue-700 mb-2"> Target vs Achieved </h3>
        <div className="flex-grow"> <Bar data={barData} options={chartOptions} /> </div>
        {/* ===== DATE FILTER ===== */}
      ...
      <div className="bg-green-50 border border-green-200 rounded-2xl shadow-md p-4 h-[280px] flex flex-col">
        <h3 className="text-sm font-semibold text-green-700 mb-2"> Achievement Trend </h3>
        <div className="flex-grow"> <Line data={lineData} options={chartOptions} /> </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
        ...
        <div className="flex gap-3">
          ...
          <button onClick={exportToExcel} className="px-5 py-2 bg-green-600 text-white rounded-full shadow hover:bg-green-700 text-sm font-semibold"
          >
            Export Excel
          </button>
        </div>
...
//         <Pagination
//           currentPage={currentPage}
//           totalPages={Math.ceil(filteredData.length / 10)} // Assuming 10 rows per page
//           setCurrentPage={setCurrentPage}
//         />
//       </div>
//     </div>
