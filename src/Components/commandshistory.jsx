        ...
        {showForm && (
          ...
          >
            ...
            >
              ...
              <form onSubmit={editingComment ? handleEditSubmission : handleFormSubmission} className="flex flex-col gap-4" >
                ...
                <div className="flex justify-between items-center">
                 ...
                 : editingComment ? 'Update' : 'Submit'
                  ...
                  <button type="submit" disabled={isSubmitting} className={`px-5 py-2 rounded-full text-base font-medium transition-all ${ isSubmitting ? 'bg-indigo-500 cursor-not-allowed opacity-75'
