...
// 💡 THE ULTIMATE FIX: Module-level flag. This variable lives 
// outside the component and is not reset when the component unmounts/remounts.
let apiCallInitModuleFlag = false; 

export default function CompanyDashboard() {
    // You can uncomment the console log here for testing, 
    // but the final goal is to stop the API call, not the render log.
    ...
    const fetchDashboardData = useCallback(async () => {
        // 💡 BYPASS CHECK: Check the module-level flag. If true, exit immediately.
        ...
        try {
            ...
            // OPTIONAL: If the API call fails, you can reset the flag to allow a retry on the next manual refresh.
