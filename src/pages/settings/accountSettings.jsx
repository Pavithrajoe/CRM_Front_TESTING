...
  const [leadFormType, setLeadFormType] = useState(null); //  start as null
...
        setBusinessTypes(list.filter(bt => bt.bactive)); // only active
      })
...
  }, [profile, toggles, leadFormType, token, companyId, errors]);
...
  }, [profile, toggles, leadFormType, token, errors]);
