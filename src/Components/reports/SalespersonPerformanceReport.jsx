...
//   // Collect all leads from perfData
            ...
            {totalPages > 1 && (
              <div className="flex justify-between items-center px-6 py-4 bg-gray-50 border-t">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-sm font-semibold bg-white border rounded-lg disabled:opacity-50 hover:bg-gray-100"
                >
                  Previous
                </button>
