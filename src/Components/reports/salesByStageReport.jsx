    ...
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      <div className="flex-1 p-8">
        ...
        <div className="flex items-center mb-6">
          <button onClick={() => navigate("/reportpage")} className="text-gray-500 hover:bg-gray-200 p-2 rounded-full mr-4" aria-label="Back to reports" >
            <FaArrowLeft />
          </button>
          <h2 className="text-3xl font-semibold text-gray-900"> Opportunity Summary by Sales Stage </h2>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
          <div className="flex justify-between items-center mb-4 flex-wrap gap-2">
            <h3 className="text-xl font-semibold text-gray-800"> Sales Pipeline Performance by Stage </h3>
            <div className="flex items-center gap-4">
              <span className="text-sm text-gray-500"> {tableData.length} stages • Last updated: {new Date().toLocaleString()} </span>
              ...
              <tbody className="divide-y divide-gray-100">
                  ...
                  {paginatedData.map((row, idx) => (
                    ...
                    <tr key={idx} className="hover:bg-gray-50 transition">
                      <td className="px-4 py-3 font-medium"> {(currentPage - 1) * 10 + idx + 1}</td>
...
//                     <tr key={idx} className="hover:bg-gray-50 transition">
//                       <td className="px-4 py-3 font-medium"> {indexOfFirstRow + idx + 1} </td>
//                       <td className="px-4 py-3 font-medium whitespace-nowrap"> {row.stage} </td>
