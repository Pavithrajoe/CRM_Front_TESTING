   ...
   <div className="hidden md:flex">
    <button
      ...
      className={`flex items-center justify-center px-3 md:px-5 py-2 rounded-full text-white font-medium 
        ...
        ${
          !(leadFormType === 1 || leadFormType === 2 || leadFormType === 3|| leadFormType === 3)
    ...
    <div className="relative" ref={appMenuRef}>
      ...
      {showAppMenu && (
        <div
          className=" fixed md:absolute right-2 md:right-0 top-16 md:top-auto md:mt-2 w-56 md:w-60 bg-white border border-indigo-200 rounded-2xl shadow-2xl p-4  z-[9999] 
