...
const LeadDetailView = () => {
  ...
  // FIXED: Get tab configuration based on company
  const getTabConfig = () => {
    ...
    if (isXcodeFix) {
      ...
      return [
        { label: "Follow-up", component: <Tasks leadId={leadId} /> },
        { label: "Activity", component: <LeadTimeline leadId={leadId} isReadOnly={isLost || isWon || immediateWonStatus || leadData?.bisConverted === true} /> }
      ];
    } else {
      // For other companies - show all tabs
      return [
        { label: "Task", component: <Tasks leadId={leadId} /> },
        { label: "Comments", component: <Comments leadId={leadId} /> },
        { label: "Reminders", component: <RemainderPage leadId={leadId} /> },
        { label: "Activity", component: <LeadTimeline leadId={leadId} isReadOnly={isLost || isWon || immediateWonStatus || leadData?.bisConverted === true} /> }
      ];
    }
  };
    ...
    <>
      <div className="flex flex-col lg:flex-row min-h-[100vh] bg-gray-100 relative overflow-x-hidden overflow-y-hidden">
        ...
        <div className="w-full lg:w-3/4 xl:w-4/5 p-2 sm:p-3 md:p-4">
          ...
          {/* Tab Content - FIXED: Use the same tabConfig for content */}
