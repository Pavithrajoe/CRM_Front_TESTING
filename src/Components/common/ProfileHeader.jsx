...
const ProfileHeader = () => {
  ...
  // ProfileHeader.jsx-la intha useEffect-ah add/replace pannunga
// ProfileHeader.jsx-la matha ella notification useEffect-aiyum remove pannittu ithai mattum vainga
useEffect(() => {
