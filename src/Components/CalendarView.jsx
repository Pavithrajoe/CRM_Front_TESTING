...
//                        <div 
//     key={task.itask_id} 
//     // Combine the existing classes with conditional classes for clickability
//     className={`pb-4 last:pb-0 border-b border-gray-200 ${task.crm_lead?.ilead_id ? 'cursor-pointer hover:bg-gray-50' : ''}`}
//     onClick={() => {
//       const leadId = task.crm_lead?.ilead_id;
//       console.log('Task Clicked - Attempting Navigation:');
//       console.log('Task ID:', task.itask_id);
//       console.log('Lead ID:', leadId);
      
//       if (leadId) {
//         // Check if `Maps` is available before calling it
//         if (typeof navigate === 'function') {
//           const destination = `/leaddetailview/${leadId}`;
//           console.log('Navigating to:', destination);
//           navigate(destination);
//         } else {
//           console.error('ERROR: The "navigate" function is not defined or available.');
//         }
//       } else {
//         console.log('Navigation skipped: No Lead ID found for this task.');
//       }
//     }}
//   >
//                                             <div className="bg-white p-5 space-y-4">
