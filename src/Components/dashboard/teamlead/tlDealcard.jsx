...
export default function DealsTable({data =[]}) {
  ...
  const { currentPage, setCurrentPage, totalPages, paginatedData: paginatedDeals,} = usePagination(filteredDeals, ITEMS_PER_PAGE);
        ...
        <table className="min-w-full divide-y divide-gray-200 text-sm" style={{ tableLayout: "fixed" }} >
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-[33.33%]"> Status </th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-[33.33%]"> Modified By </th>
            </tr>
          </thead>
