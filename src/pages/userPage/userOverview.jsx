...
export default function KPIStats() {
  ...
  const kpiData = [
    { title: "Hot", value: hotCount, color: "text-red-500", bg: "/illustrations/hot.svg" },
    { title: "Warm", value: warmCount, color: "text-orange-500", bg: "/illustrations/warm.svg" },
    { title: "Cold", value: coldCount, color: "text-blue-500", bg: "/illustrations/cold.svg" },
    { title: "Total Won", value: wonCount, color: "text-green-600", bg: "/illustrations/win.svg" },
  ];
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-2xl font-bold text-gray-900">{totalLeadCount}</p>
          </div>
          <div
            className="bg-white/60 border border-white/30 rounded-xl p-4 shadow-sm cursor-pointer"
            // onClick={handleActiveLeadClick}
          >
            <h3 className="text-xs font-bold text-gray-600 mb-1 tracking-tight">
              Active Leads
            </h3>
          ...
          <div
            className="bg-white/60 border border-white/30 rounded-xl p-4 shadow-sm cursor-pointer"
            // onClick={handleWebsiteLeadClick}
          >
            <h3 className="text-xs font-bold text-gray-600 mb-1 tracking-tight">
              Website Leads
            </h3>
