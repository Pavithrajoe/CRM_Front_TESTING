...
// //   const res = await axios.get(
// //      `${ENDPOINTS.REVENUE_REPORT}/${companyId}`,
// //   // `http://192.168.29.236:3000/api/reports/revenue/${companyId}`,
// //     {
// //       headers: { Authorization: `Bearer ${token}` },
// //       params: {
// //         groupBy: "time",
...
// //   const fetchRevenue = async (type, options = {}) => {
// //   const token = localStorage.getItem("token");

// //   const params = { groupBy: type };

// //   // ✅ Only attach date filters for TIME
// //   if (type === "time") {
...
// //   setLoading(true);
// //   fetchRevenue("time", { fromDate: from, toDate: to })
// //     .then(setReportData)
// //     .finally(() => setLoading(false));
...
// //   Applyen Filters for the Custom Date Range. 
// // </p>
// //       </div>
// //     )}
...
//   const res = await axios.get( `${ENDPOINTS.REVENUE_REPORT}/${companyId}`,
//     {
//       headers: { Authorization: `Bearer ${token}` },
//       params: {
//         groupBy: "time",
