...
//   const [profile, setProfile] = useState({   // Profile related state
//     companyName: "",
//     email: "",
//     phone: "",
//     gst: "",
...
//   const [generalSettings, setGeneralSettings] = useState({    // General settings (checkboxes + prefix)
//     whatsapp_active: false,
//     mail_active: false,
//     website_active: false,
//     phone_active: false,
...
//   useEffect(() => {
//     if (!token) return;
//     axios.get(`${ENDPOINTS.BUSINESS_TYPE}`, {
//       headers: { Authorization: `Bearer ${token}` },
//     }).then(res => {
//       const list = res.data?.data?.data || [];
//       console.log(list)
...
//     setLoading(true);
//     axios.get(`${ENDPOINTS.COMPANY}/${companyId}`, {
//       headers: { Authorization: `Bearer ${token}` }
//     }).then(res => {
//       const data = res.data.result;
//       if (data && data.cCompany_name) {
