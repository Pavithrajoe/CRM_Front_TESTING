...
export const fetchLeads = (type = "self") => async (dispatch) => {
  ...
  try {
    ...
    if (type === "all") {
      //  ALL COMPANY LEADS
      url = `${ENDPOINTS.LEAD_DETAILS}?page=1&limit=10000`;
    } else {
      ...
      url = `${ENDPOINTS.LEAD}${userId}?page=1&limit=10000`;
    }
