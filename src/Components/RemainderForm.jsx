...
const RemainderForm = () => {
  return (
    <div className="p-6">
      ...
      <textarea
        className="w-full border p-2 mb-2 rounded h-65 bg-[#EEEEEE]"
      ...
      <div className="flex flex-wrap gap-4 mb-4">
        <div>
          ...
          <select className="border p-2 rounded w-40 bg-[#EEEEEE]">
        ...
        <div>
          ...
          <input type="date" className="border p-2 rounded w-40 bg-[#EEEEEE]" />
        </div>

        <div>
          <label className="text-sm block mb-1">Time</label>
          <div className="flex">
            <input type="time" className="border p-2 rounded w-28 bg-[#EEEEEE]" />
          </div>
        </div>
      </div>
